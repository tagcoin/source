...
static const char *strDNSSeed[][2] = {
    {"tagbond0.com", "dnsseed.tagbond.com"},
    {"tagbond1.com", "tag.cryptopools.com"},
    {"tagbond2.com", "52.6.244.211"},
	{"tagbond3.com", "seed1.tagbond.com"},
	{"tagbond3.com", "seed4.tagbond.com"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("TagCoin-dnsseed");
