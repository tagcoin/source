...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("TagCoins"));
    case mBTC: return QString(QObject::tr("Milli-TagCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-TagCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
