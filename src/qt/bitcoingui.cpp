...
void BitcoinGUI::createActions()
{
    ...
    aboutAction->setStatusTip(tr("Show information about TagCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TagCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TagCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TagCoin addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your TagCoin addresses"));
