...
CBigNum bnProofOfStakeLimit(~uint256(0) >> 24); // proof of stake target limit since 20 June 2013, equal to 0.03125  proof of stake difficulty
...
int64_t nChainStartTime = 1382065867;
...
{
    return bnProofOfWorkLimit; // return bnProofOfWorkLimit
}
...
{
    int64_t nRewardCoinYear = 0.015 * CENT;
...
static const int64_t nTargetTimespan = 2 * 60 * 60;			//2 hrs
static const int64_t nTargetSpacingProofOfWork = 4 * 60;		//4 min
static const int64_t nTargetSpacingWorkMax = 3 * nTargetSpacingProofOfWork; //12 min
...
if (nHeight >= 12000) 
{
...
else    //Old difficulty algorithm, prior to block 12000
 {
	...
	{
        int64_t nInterval = nTargetTimespan / nTargetSpacingProofOfWork;
    ...
    int64_t nActualTimespanMax = nTargetTimespan * 1.25;
    int64_t nActualTimespanMin = nTargetTimespan * 0.75;
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // TagCoin: check proof-of-stake block signature
